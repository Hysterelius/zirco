...
<template>
  <div class="flex flex-col gap-2">
    ...
    >
      <DatePickerField
        v-slot="{ segments }"
        class="w-36 flex select-none bg-accented text-muted items-center rounded-lg shadow-sm text-center justify-between text-green10 border p-1 data-[invalid]:border-red-500"
      >
